...
function registrarLibro() {
  ...
  do {
    ...
    codigo = parseInt(prompt("Por favor Ingrese el código del libro."))

    if (nombre == "" || autor == "" || genero== "" || codigo == 0 || isNaN(codigo)) {
      alert("Por favor ingresa los datos correctamente.")
    } else {
      alert("El libro se ha registrado correctamente.")
    }
  } while (nombre == "" || autor == "" || genero== "" || codigo == 0 || isNaN(codigo))
